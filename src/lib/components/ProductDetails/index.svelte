<script lang="ts">
	...
	import type { ProductDetails_ProductFragment } from '$lib/server/types';

	export let product: ProductDetails_ProductFragment;

	const images = new Array(4)
		.fill(product.image[0])
		.map((img, index) => product.image[index] ?? img);
</script>
	...
	<div class="pt-6">
		...
		>
			...
			<div class="mt-4 lg:mt-0 lg:row-span-3">
				...
				<p class="text-3xl text-gray-900">{product.offers.lowPrice}$</p>
				...
				<div class="mt-10">
					...
					<div class="mt-4 space-y-6">
						<p class="text-sm text-gray-600">
							...
							our subscription service and be the first to get new, exciting colors, like our
